  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-16 sm:px-16 sm:py-24">
      ...
      <div className="space-y-6 text-base leading-8 text-zinc-600 dark:text-zinc-400">
        <p>
          Hi, I&apos;m{" "}
          <span className="font-semibold text-zinc-900 dark:text-zinc-100">Amandi Nimasha</span> — a
          Software Engineer and Full Stack Developer passionate about building clean, thoughtful
          digital experiences.
        </p>
        <p>
          I specialize in designing and developing scalable web applications using modern
          technologies like React, Next.js, Node.js, and TypeScript. I care deeply about both the
          engineering quality and the user experience of the products I build.
        </p>
        <p>
          Beyond code, I enjoy exploring emerging technologies, contributing to open-source
          projects, and constantly pushing the boundaries of what&apos;s possible on the web.
        </p>
      </div>
      ...
      <div className="mt-14">
        ...
        <div className="flex flex-wrap gap-4">
          {[
            ...
            { label: "Email", href: "mailto:amandi@example.com" },
          ].map((link) => (
            <a
              key={link.label}
              href={link.href}
