...
import ColourPallet from "./components/ColourPallet";
...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center bg-white pt-14 font-mono dark:bg-black">
      <BackgroundCharm />
